...
import FiltersWrapper from "@/components/core/common/filters-wrapper";
import SidebarDrawer from "@/components/core/common/sidebar-drawer";
import ecommerceItems from "@/helpers/data/ecommerce-items";
    ...
    <div className="max-w-8xl h-full w-full px-2 pb-16 lg:px-24">
      <nav className="my-4 px-2 py-2">
        <Breadcrumbs>
          ...
          <BreadcrumbItem>Áo thun</BreadcrumbItem>
        </Breadcrumbs>
      </nav>
        ...
        <div className="w-full flex-1 flex-col">
          ...
          <main className="mt-4 h-full w-full overflow-visible px-1">
            <div className="block rounded-medium">
              ...
              <ProductsGrid className="grid-cols-1 gap-5 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3" />
            </div>
          </main>
        </div>
      </div>
